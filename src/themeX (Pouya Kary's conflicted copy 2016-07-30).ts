...
//
    ...
    export function forEachThemeDo ( project: IBundle.base,
                                     address: string,
                                        func: ( theme: ICurrentTheme ) => void ) {
        for ( let _forEachThemeThemeIndex = 0; _forEachThemeThemeIndex < project.project.themes.length; _forEachThemeThemeIndex++ ) {
            func({
                theme: project,
                index: _forEachThemeThemeIndex,
                path: address
            });
        }
    }
